...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      {/* Navigation */}
      <nav className="bg-white/80 backdrop-blur-md border-b border-slate-200 sticky top-0 z-50 dark:bg-slate-900/80 dark:border-slate-700">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4"> {/* Added flex container for nav links and toggle */}
              <div className="hidden md:flex items-center space-x-8">
                <Link href="#modules" className="text-slate-600 hover:text-orange-500 transition-colors dark:text-slate-300 dark:hover:text-orange-400">
                  Modules
                </Link>
                <Link href="#question-sets" className="text-slate-600 hover:text-orange-500 transition-colors dark:text-slate-300 dark:hover:text-orange-400">
                  Question Sets
                </Link>
                <Link href="#about" className="text-slate-600 hover:text-orange-500 transition-colors dark:text-slate-300 dark:hover:text-orange-400">
                  About
                </Link>
              </div>
      ...
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden dark:bg-gradient-to-br dark:from-slate-900 dark:via-blue-950 dark:to-indigo-950">
...
/>
          ...
          <p className="text-xl text-slate-600 mb-8 max-w-3xl mx-auto leading-relaxed dark:text-slate-300">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <div className="text-slate-600 dark:text-slate-300">Practice Questions</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-red-500 mb-2">11</div>
              <div className="text-slate-600 dark:text-slate-300">Question Sets</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-blue-500 mb-2">10</div>
              <div className="text-slate-600 dark:text-slate-300">Learning Modules</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-green-500 mb-2">CLF-C02</div>
              <div className="text-slate-600 dark:text-slate-300">Latest Exam</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 dark:bg-slate-900">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 dark:bg-slate-800 dark:text-white dark:shadow-slate-700/50">
...
10 comprehensive modules covering all exam domains with targeted questions for focused practice.                </CardDescription>
      ...
      <section id="question-sets" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-slate-50 to-blue-50 dark:from-slate-800 dark:to-blue-900">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {Array.from({ length: 11 }, (_, i) => (
              <Card
                key={i + 1}
                className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group dark:bg-slate-800 dark:text-white dark:shadow-slate-700/50"
              >
                ...
                <CardContent>
                  <CardDescription className="mb-4 dark:text-slate-400">
      ...
      {/* Modules Section */}
      <section id="modules" className="py-20 px-4 sm:px-6 lg:px-8 dark:bg-slate-900">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              >
                ...
                <CardContent>
                  <CardDescription className="mb-4 text-base dark:text-slate-400">{module.description}</CardDescription>
      ...
      {/* About Section */}
      <section id="about" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-orange-50 to-red-50 dark:from-slate-800 dark:to-red-900">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-slate-800 mb-8 dark:text-white">About This Platform</h2>
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg dark:bg-slate-800/80 dark:shadow-slate-700/50">
            ...
            <p className="text-lg text-slate-600 mb-8 leading-relaxed dark:text-slate-300">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="flex items-center justify-center">
                ...
                <span className="text-slate-700 dark:text-slate-300">Mobile Responsive</span>
              </div>
              <div className="flex items-center justify-center">
                <CheckCircle className="w-5 h-5 text-green-500 mr-2" />
              ...
              <div className="flex items-center justify-center">
                <CheckCircle className="w-5 h-5 text-green-500 mr-2" />
                <span className="text-slate-700 dark:text-slate-300">Detailed Analytics</span>
              </div>
            </div>
      ...
      {/* Footer */}
      <footer className="bg-slate-800 text-white py-12 px-4 sm:px-6 lg:px-8 dark:bg-slate-950">
