        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-slate-800">Question Sets</span>
            </div>
          </div>
        </div>
      </nav>
                ...
                <CardContent>
                  ...
                  <div className="space-y-2 mb-4">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium">150 minutes</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-slate-600">Question Count:</span>
                      <span className="font-medium">{set.questions} questions</span>
                    </div>
                  </div>
